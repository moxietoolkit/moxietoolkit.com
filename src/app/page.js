export default function Home() {
  return (
    <div className="">
      ...
      <p className="text-lg">In the meantime Grimwild&apos;s free rules are available at <a href="https://www.drivethrurpg.com/en/product/507201/grimwild-free-edition?affiliate_id=144937" className="text-grimwild-blue underline">DriveThruRPG</a>.</p>
